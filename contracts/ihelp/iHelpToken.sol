...
contract iHelpToken is ERC20CappedUpgradeable, OwnableUpgradeable {
    ...
    function registerCharityPool(address _addr) public onlyOperatorOrOwner returns(address) {
        // TODO: BB - called from charity deploy script - should never be null - add require check
    ...
    function charityPoolInRegistry(address _addr) public view returns(address) {
        // TODO - BB replace this function with direct __charityPoolRegistry[_addr] access
    ...
    function dripStage2() external onlyOperatorOrOwner {
        ...
        if (tokensToCirculate >= __totalSupply) {
            ...
            // TODO: BB - look into. What happens if this is 0, do we get an underflow @ Line 396??. Can this be 0?
