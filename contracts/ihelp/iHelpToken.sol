...
contract iHelpToken is ERC20CappedUpgradeable, OwnableUpgradeable {
    ...
    // TODO: charityPoolInRegistry and  isCharityAddress can be merged into the same function ??
    ...
    function dripStage2() external {
        ...
        if (tokensToCirculate >= __totalSupply) {
            ...
            // TODO: What happens if this is 0, do we get an underflow @ Line 396??. Can this be 0?
    ...
    function claimInterest(address _addr) public {
        ...
        // TODO: Dont understant what pools are we resetting the interest on.
        if (isCharityAddress(_addr) || holdingPool == _addr) {
            console.log("off-chain transfer to charity wallet - not touching anything"); // TODO: IMPORTANT. Remove all uncecessary branching when moving to production
        } else {
    ...
    // TODO: NO NEED FOR THIS GETTER stakingPool is public. Removing it optimzes deplyment costs
    function getStakingPool() public view returns (address) {
        return stakingPool;
    }

    // TODO: NO NEED FOR THIS GETTER holdingPool is public. Removing it optimzes deplyment costs
